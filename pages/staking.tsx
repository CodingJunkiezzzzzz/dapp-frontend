...
export default function Staking() {
  const AllStakingPools = () => (
    <div className="flex flex-col md:flex-row justify-center items-center gap-3 flex-nowrap md:flex-wrap overflow-auto hidden-scrollbar flex-1 w-full h-full">
      {_.map(mockData, (data, index) => (
        <div className="w-full md:w-1/5 px-[3px]" key={index}>
          <StakingPoolCard
  ...
  return (
    <div className="flex flex-col justify-evenly gap-4 items-start w-full h-full bg-radialed overflow-auto hidden-scrollbar">
      ...
      <div className="flex flex-1 border-[#ffeb82] border-t rounded-t-[20px] flex-col gap-7 w-full backdrop-opacity-10 backdrop-invert px-[2px] py-[10px] md:px-[82px] md:py-[44px] overflow-auto hidden-scrollbar">
